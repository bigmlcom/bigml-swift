...
public func chi2ppf(p : Double, _ n : Int) -> Double {
...
func chi2ppm(conf : Double, fails : Double, total : Double) -> Double {
...
public func norm(z : Double) -> Double {
    let q = z * z
    if (abs(z) > 7.0) {
...
public func chi2(x : Double, _ n : Int) -> Double {
